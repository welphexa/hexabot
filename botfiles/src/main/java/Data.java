...
public class Data implements Listener {
	...
	public void onCommandMessageReceived(CommandMessageReceivedEvent event) {
		...
		if (receivedMessage.equals("/save") && (id == Main.id || Main.admins.contains(id))) {
			saveData();
		}
	}
	
	public void saveData() {
		try (BufferedWriter br = new BufferedWriter(new FileWriter(userCash))) {
		...
		try (BufferedWriter br = new BufferedWriter(new FileWriter(stocks))) {
			for (String username : Stocks.shares.keySet()) {
				br.write(username + ":" + Stocks.shares.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(stockPrice))) {
			br.write(Stocks.stockPrice);
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(cars))) {
			for (String username : Properties.cars.keySet()) {
				br.write(username + ":" + Properties.cars.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(apartments))) {
			for (String username : Properties.apartments.keySet()) {
				br.write(username + ":" + Properties.apartments.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(stores))) {
			for (String username : Properties.stores.keySet()) {
				br.write(username + ":" + Properties.stores.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(mansions))) {
			for (String username : Properties.mansions.keySet()) {
				br.write(username + ":" + Properties.mansions.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(jets))) {
			for (String username : Properties.jets.keySet()) {
				br.write(username + ":" + Properties.jets.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(islands))) {
			for (String username : Properties.islands.keySet()) {
				br.write(username + ":" + Properties.islands.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(spaceships))) {
			for (String username : Properties.spaceships.keySet()) {
				br.write(username + ":" + Properties.spaceships.get(username) + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(bankmoney))) {
			br.write(BankRob.bankMoney);
		} catch (Exception e) {
			e.getMessage();
		}
		try (BufferedWriter br = new BufferedWriter(new FileWriter(pokemonIndexes))) {
			for (String username : Pokemon.pokemons.keySet()) {
				String str = username + ":";
				for (String s : Pokemon.pokemons.get(username)) {
					str += s + ",";
				}
				br.write(str + "\n");
			}
		...
		try (BufferedWriter br = new BufferedWriter(new FileWriter(pokeballs))) {
			for (String username : Pokemon.pokeballs.keySet()) {
				String str = username + ":" + Pokemon.pokeballs.get(username) + "," + Pokemon.wins.get(username) + "," + Pokemon.losses.get(username);
				br.write(str + "\n");
			}
		} catch (Exception e) {
			e.getMessage();
